...
\end{equation}
```
If we consider a graph $V$ that had identical distributions for the probabilities of causal relations $P(v)$, but different distributions for mechanisms $P(\Omega')$, we could then define when a study that increased our understanding of mechanisms would be preferable iff:
